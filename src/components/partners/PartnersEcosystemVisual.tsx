...
const PartnersEcosystemVisual = memo(function PartnersEcosystemVisual() {
  return (
    <div className="relative w-full max-w-[500px] sm:max-w-[540px] aspect-square mx-auto flex items-center justify-center select-none overflow-visible will-change-transform">
      ...
      >
        ...
        <g transform="translate(270, 270)" className="drop-shadow-[0_8px_16px_rgba(235,87,37,0.32)]">
          ...
          <circle cx="0" cy="0" r="54" fill="#EB5725" stroke="#FFFFFF" strokeWidth="2.5" />
