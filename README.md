...
![AIC-JKLU Cover Banner](https://img.shields.io/badge/AIC--JKLU-Atal%20Incubation%20Centre-EB5725?style=for-the-badge&logoColor=white)
![Next.js 14](https://img.shields.io/badge/Next.js-14.2%20App%20Router-black?style=for-the-badge&logo=next.js&logoColor=white)
...
![Playwright](https://img.shields.io/badge/Playwright-E2E%20Tests-2EAD33?style=for-the-badge&logo=playwright&logoColor=white)
...
```mermaid
graph TD
    AIC[AIC-JKLU Incubation Hub]
    AIC --> P1[01. Accelerator Program]
    AIC --> P2[02. Incubation Program]
    AIC --> P3[03. RISE Initiative]
    AIC --> P4[04. LEAP Program]

    P1 -->|Focus| P1F[Sustainable Biomaterial Solutions & Circular Economy]
    P2 -->|Focus| P2F[Sector-Agnostic Deeptech, AI, Hardware, SaaS]
    P3 -->|Focus| P3F[Rural India Solutions for Energy & Clean Tech]
    P4 -->|Focus| P4F[Longevity Economy, Healthcare & Active Aging]
```
